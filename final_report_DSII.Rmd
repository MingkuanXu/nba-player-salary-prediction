...
From numeric variables, we found that `age`,`game`, `game_starting`,`free_throw`, `personal_foul`, `point` seem to have some non-linear trends. Therefore, we would choose to use GAM, MARS, random forest and neural network model to predict the salary.

![Featureplot of predictors with non-linear trends](report_figures/figure3_featureplot.png)
...
## Part 3: Tree based Models Models
