...
df_train_scaled_x = df_train_scaled[1:21]
df_train_scaled_y = df_train_scaled$salary

df_test_scaled_x = df_test_scaled[1:21]
df_test_scaled_y = df_test_scaled$salary

learn <- model3 %>% fit(df_train_scaled_x, df_train_scaled_y,
                        epochs = 30,
                        batch_size = 128,
...
```{r}
score <- 
  model3 %>% evaluate(df_test_scaled_x, df_test_scaled_y)
score
```