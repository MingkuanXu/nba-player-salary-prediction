...
plot(df_train_scaled$salary, pr.train.nn$net.result, col = "red", 
     main = 'Real vs Predicted')
abline(0, 1, lwd = 2)

plot(df_test_scaled$salary, pr.test.nn$net.result, col = "red", 
     main = 'Real vs Predicted')
abline(0, 1, lwd = 2)
...
#df_train_scaled_x = array(df_train_scaled %>% dplyr::select(-salary))
df_train_scaled_x = scale(model.matrix(salary~., df_train_scaled)[,-1],center = TRUE, scale = TRUE)

df_train_scaled_y = df_train_scaled$salary

df_test_scaled_x = scale(model.matrix(salary~., df_test_scaled)[,-1],center = TRUE, scale = TRUE)
df_test_scaled_y = df_test_scaled$salary
