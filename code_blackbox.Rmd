...
df_train_scaled_x = scale(model.matrix(salary~., df_train)[,-1],center = TRUE, scale = TRUE)

df_train_scaled_y = df_train$salary

df_test_scaled_x = scale(model.matrix(salary~., df_test)[,-1],center = TRUE, scale = TRUE)
