...
```{r}
gbm.grid3 <- expand.grid(n.trees = c(4000,5000,6000,7000),
...
* `mytry = 28`: number of variables to possibly split at in each node. 
...
explainer.rf <- lime(df_pred[indexTrain,-24], rf.fit3)

new_obs <- df_pred[-indexTrain,-24][1:6,]
