...
```{r}
gbm.grid <- expand.grid(n.trees = c(4000,5000,6000,7000),
                        interaction.depth = 4:5,
                        shrinkage = c(0.0006, 0.0008,0.001),
                        n.minobsinnode = 1)
...
```{r}
gbm.grid2 <- expand.grid(n.trees = c(4000,5000,6000,7000),
