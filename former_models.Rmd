...
```{r joining datasets, echo=FALSE,message=FALSE,warning=FALSE}
...
```{r data partition, echo=FALSE,message=FALSE,warning=FALSE}
set.seed(8106)
...
summary(resamp)$statistics$RMSE %>% knitr::kable(caption = "Table 1: RMSE of Different Models",digits=2)
