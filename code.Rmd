...
```{r fig.height = 6}
par(mfrow=c(3,3))
hist(df_appendix_b$x2p_attempt,main = "x2p_attempt")
hist(df_appendix_b$free_throw,main = "free_throw")
hist(df_appendix_b$ft_attempt,main = "ft_attempt")
hist(df_appendix_b$offensive_rb,main = "offensive_rb")
hist(df_appendix_b$defenssive_rb,main = "defenssive_rb")
hist(df_appendix_b$total_rb,main = "total_rb")
hist(df_appendix_b$assistance,main = "assistance")
hist(df_appendix_b$steal,main = "steal")
hist(df_appendix_b$block,main = "block")
```
